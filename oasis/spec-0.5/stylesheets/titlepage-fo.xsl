...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'topic')]"/>
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[@role = 'namespaces']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[@role = 'namespaces']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[@role = 'namespaces']"/>
